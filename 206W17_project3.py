...
# LOAD UMICH USER INTO USERS TABLE
...
for tweet in umich_tweets:
	for each in tweet['entities']['user_mentions']:
		user_info= api.get_user(each['screen_name'])
...
new= cur.execute(query).fetchall()
descriptions_fav_users= [tup[0] for tup in new]
...
# twitter_info_diction[screen_names]= tweet_text
